 ...
 */
export async function checkGraduationStatus(connection, tokenMint) {
    try {
...
async function checkAMMPoolExistence(connection, tokenMint) {
    try {
        ...
        try {
            ...
            debugLog(`   ❌ Error searching program accounts: ${error.message}`);
        }
...
async function checkAMMPoolLiquidity(connection, tokenMint) {
    try {
        ...
        try {
            ...
            debugLog(`❌ Error checking pool liquidity: ${error.message}`);
        }
 ...
 */
export async function getGraduationAnalysis(connection, tokenMint) {
    try {
