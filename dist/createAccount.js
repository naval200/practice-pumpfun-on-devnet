...
export async function createAssociatedTokenAccount(connection, payer, owner, mint) {
    try {
        ...
        console.log(`🏗️ Creating ATA: ${userTokenAccount.toString()}`);
        ...
        try {
            ...
            console.log('🏗️ Creating new associated token account...');
        }
        ...
        console.log(`📡 ATA creation transaction sent! Signature: ${signature}`);
 ...
 */
export async function getOrCreateAssociatedTokenAccount(connection, payer, owner, mint) {
    try {
        const userTokenAccount = await getAssociatedTokenAddress(mint, owner);
        // Check if ATA exists
        try {
